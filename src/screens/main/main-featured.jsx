  ...
  "items": [
    ...
    },
    {
      "attributes": {
        ...
        "image_url": "https://source.unsplash.com/random/800x800",
        "description": "Voluptatem sit consequatur perferendis aut accusantium. Voluptatem sit accusantium perferendis aut consequatur. Sit perferendis consequatur accusantium voluptatem aut. Voluptatem sit accusantium perferendis aut consequatur.",
      ...
      "relationships": {
        "address": {
          ...
          "province": "nesciunt",
          "city": "ex",
          "street_name": "Perferendis voluptatem consequatur accusantium aut sit.",
          "zip_code": 17015
        },
        "categories": [
          "Fragile"
    ...
    },
    {
      "attributes": {
        ...
        "image_url": "https://source.unsplash.com/random/800x800",
        "description": "Voluptatem aut perferendis consequatur accusantium sit. Perferendis consequatur aut voluptatem sit accusantium. Sit aut accusantium voluptatem perferendis consequatur. Voluptatem accusantium aut sit perferendis consequatur. Aut accusantium sit voluptatem consequatur perferendis. Aut voluptatem consequatur accusantium sit perferendis. Sit voluptatem perferendis consequatur accusantium aut. Voluptatem perferendis aut sit accusantium consequatur.",
      ...
      "relationships": {
        "address": {
          ...
          "province": "facere",
          "city": "unde",
          "street_name": "Accusantium sit consequatur perferendis aut voluptatem.",
          "zip_code": 17413
        },
        "categories": [
          "Heavy Materials",
...
export function Featured({ navigation }) {
  ...
  const FeaturedWarehouseCard = ({ item }) => {
    const keyedCategories = item.relationships.categories.map(category => category.toLowerCase())

    const categoryIcons = (
      keyedCategories.map(category => {
          if (category === 'fragile') {
            return (
                <IconFragileCategory />
                  )
